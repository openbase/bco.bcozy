...
public class TreeChartController implements ChartController {
    ...
    private Image getImageByPowerDraw(ChartData datum) {
        if (datum.getValue() > 2000) {
            return new Image(getClass().getResource("/resources/images/tree0.png").getPath());
        } else if (datum.getValue() > 1500) {
            return new Image(getClass().getResource("/resources/images/tree1.png").getPath());
        } else if (datum.getValue() > 900) {
            return new Image(getClass().getResource("/resources/images/tree2.png").getPath());
        } else if (datum.getValue() > 600) {
            System.out.println(getClass().getResource("/resources/images/tree3.png"));
            return new Image(getClass().getResource("/resources/images/tree3.png").getPath());
        } else if (datum.getValue() > 400) {
            return new Image(getClass().getResource("/resources/images/tree4.png").getPath());
        } else if (datum.getValue() > 200) {
            return new Image(getClass().getResource("/resources/images/tree5.png").getPath());
        } else if (datum.getValue() > 0) {
            return new Image(getClass().getResource("/resources/images/tree6.png").getPath());
        } else {
            return new Image(getClass().getResource("/resources/images/tree7.png").getPath());
        }
    }
