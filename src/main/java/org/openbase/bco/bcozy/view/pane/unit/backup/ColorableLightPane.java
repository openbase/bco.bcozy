 ...
 * ==================================================================
 */
package org.openbase.bco.bcozy.view.pane.unit.backup; //NOPMD //TODO: Split up in several classes
...
//        try {
//            getUnitRemote().setPowerState(powerState).get(Constants.OPERATION_SERVICE_MILLI_TIMEOUT, TimeUnit.MILLISECONDS);
...
//        try {
//            getUnitRemote().setColor(hsvColor).get(Constants.OPERATION_SERVICE_MILLI_TIMEOUT, TimeUnit.MILLISECONDS);
...
//
//    @Override
//    void applyDataUpdate(final ColorableLightData data) {
//        Platform.runLater(() -> {
//            final State powerState = data.getPowerState().getValue();
//            final Color color = Color.hsb(((ColorableLightData) data).getColorState().getColor().getHsbColor().getHue(),
//                    ((ColorableLightData) data).getColorState().getColor().getHsbColor().getSaturation()
//                    / Constants.ONE_HUNDRED,
//                    ((ColorableLightData) data).getColorState().getColor().getHsbColor().getBrightness()
//                    / Constants.ONE_HUNDRED);
//            setEffectColorAndSwitch(powerState, color);
//        });
//    }
